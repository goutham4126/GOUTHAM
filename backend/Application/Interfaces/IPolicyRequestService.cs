...
namespace Application.Interfaces
{
    ...
    {
        Task<PolicyRequestDto> CreatePolicyRequestAsync(Guid userId, Guid planId, int durationMonths, PaymentFrequency paymentFrequency, byte[] panFileBytes, string panFileName, byte[] addressFileBytes, string addressFileName, string kycDetailsJson);
