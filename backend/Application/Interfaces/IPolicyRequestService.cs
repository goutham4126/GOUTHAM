...
namespace Application.Interfaces
{
    public interface IPolicyRequestService
    {
        ...
        Task<PolicyRequestDto> ApproveRequestAsync(Guid requestId, Guid agentId);
        Task<PolicyRequestDto> RejectRequestAsync(Guid requestId, Guid agentId, string reason);
    }
}
